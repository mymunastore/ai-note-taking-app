...
import { Mic, Brain, Globe, Zap, Shield, Users, ArrowRight, Check, Star, AlertCircle, Loader2 } from "lucide-react";
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Loading Screen */}
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50/50 via-teal-50/50 to-blue-50/50 dark:from-emerald-950/20 dark:via-teal-950/20 dark:to-blue-950/20">
        <div className="text-center">
          <div className="flex items-center justify-center gap-3 mb-8">
            <div className="w-16 h-16 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-lg flex items-center justify-center animate-pulse">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">AI Voice Intelligence</p>
            </div>
          </div>
          
          <div className="flex items-center justify-center gap-3 mb-4">
            <Loader2 className="w-6 h-6 animate-spin text-emerald-600" />
            <span className="text-lg text-foreground">Loading your AI workspace...</span>
          </div>
          
          <p className="text-muted-foreground max-w-md mx-auto">
            Preparing your intelligent voice recording and transcription environment
          </p>
      ...
      {/* Hidden content - keeping the original structure for SEO and fallback */}
