...
```bash
git remote add encore encore://ai-note-taking-app-nkyi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/ai-note-taking-app-nkyi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/ai-note-taking-app-nkyi/settings/integrations/github)
